            ...
            <div class="mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 py-6 px-4">
                    ...
                    <div class=" ">
                        ...
                        <input type="number" name="offer" value="{{ $banner_data->offer }}" class=" rounded-md focus:ountline-none focus:ring-1 focus:blue-400 shadow  w-full py-2 px-2   bg-gray-100 border-none">
                        @error('offer')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    <div class=" ">
                        ...
                        <textarea name="quote" rows="3" class=" rounded-md focus:ountline-none focus:ring-1 focus:blue-400 shadow  w-full py-2 px-2   bg-gray-100 border-none">{{$banner_data->quote}}</textarea>
                        @error('quote')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>

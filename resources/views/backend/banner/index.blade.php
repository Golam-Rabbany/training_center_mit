    ...
    <table id="myTable" class="table-auto border-collapse border border-slate-500 w-full ">
        <thead>
          <tr>
            ...
            <th class="border border-slate-600 text-center px-2 py-3">Banner Photo</th>
            <th class="border border-slate-600 text-center px-2 py-3">Banner Offer</th>
            <th class="border border-slate-600 text-center px-2 py-3">Banner Quote</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="border border-slate-600 text-center px-2 py-3 flex justify-center">
              <img class="w-24" src="{{asset('uploads/banner/'.$datas->banner_photo)}}" alt="">
            </td>
            <td class="border border-slate-600 text-center px-2 py-3">{{$datas->offer}}</td>
            <td class="border border-slate-600 text-center px-2 py-3">{{$datas->quote}} Month</td>
            <td class="border border-slate-600 text-center px-2 py-3">
            <div class="flex justify-center">
                <div class="mr-4">
                    <a href="{{route('banner.edit',$datas->id)}}">
                ...
                <form action="{{route('banner.destroy',$datas->id)}}" method="post">
                    @csrf
                    @method('delete')
